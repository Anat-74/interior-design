...
const dialogElement = useTemplateRef<HTMLDialogElement>('dialog-pricing-three')
   const openDialog = () => {
...
<template>
   ...
   />
   <dialog 
   class="dialog-pricing-three"
   ref="dialog-pricing-three"
   id="dialogPricingThree" 
   aria-label="We offer you the first category of construction" 
   >
     <div class="dialog-pricing-three__items">
         <UButton 
         @click="closeDialog"
         name-class="close"
         aria-label="Close modal window"
          />
       <div class="dialog-pricing-three__content">
         We offer you the third category of construction
       </div>
     </div>
   </dialog>
</div>
