...
const slides = [
   { idx: 1, imageUrl: "images/kids-slider-image.jpg", title: 'Kids Bedroom With Decorations', descr: 'Apartments & flats' },
   { idx: 2, imageUrl: "images/modern-slider-image.jpg", title: 'Modern Double Bedroom', descr: 'Apartments & flats' },
   { idx: 3, imageUrl: "images/scandinavian-slider-image.jpg", title: 'Scandinavian Style Interior', descr: 'Private houses' },
   { idx: 4, imageUrl: "images/kids-slider-image.jpg", title: 'Kids Bedroom With Decorations', descr: 'Apartments & flats' },
   { idx: 5, imageUrl: "images/modern-slider-image.jpg", title: 'Modern Double Bedroom', descr: 'Apartments & flats' },
   { idx :6, imageUrl: "images/scandinavian-slider-image.jpg", title: 'Scandinavian Style Interior', descr: 'Private houses' }
]
</script>
    ...
    <section class="page-inner-services__projects-section projects-section">
      <div class="projects-section__container">
        ...
        <ClientOnly>
          ...
          >
            <swiper-slide 
            class="projects-section__swiper-slide"
            :lazy="true"
            ...
            <NuxtImg
              ...
              <div class="projects-section__slide-content slide-content">
                ...
                <UButton
                  class="slide-content__btn"
                  name-class="slider-stroke"
                  label="View Project"
                />
              </div>
            </swiper-slide>
